        ...
        <SectionHeading
          ...
          title={
            <>
              ...
              <span className="text-gradient">From Data</span>
            </>
          }
        />
        ...
        <div className="mt-16 grid items-center gap-12 lg:grid-cols-[1.05fr_1fr] lg:gap-16">
          <Reveal>
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              {highlights.map((highlight) => (
                <Card
                  key={highlight.title}
                  className="gap-0 rounded-2xl border-border/70 bg-card/60 p-5 shadow-none"
                >
                  <div
                    className={`flex h-10 w-10 items-center justify-center rounded-lg ${highlight.tile}`}
                  >
                    <highlight.icon
                      aria-hidden="true"
          ...
          <Reveal delay={120}>
            <div className="relative">
              <div
                aria-hidden
                className="absolute -inset-6 rounded-3xl bg-chart-1/10 blur-2xl"
              />
              <div className="relative overflow-hidden rounded-2xl border border-border/70 bg-card/60 font-mono text-[15px] shadow-2xl shadow-black/40 backdrop-blur-xl">
                ...
                <div className="space-y-3 p-5 text-[13px] leading-relaxed">
                  ...
                  <p>
                    <span className="text-chart-1">$</span>{" "}
                    <span className="animate-pulse-soft inline-block text-chart-3">
                      ▌
                    </span>
                  </p>
                </div>
